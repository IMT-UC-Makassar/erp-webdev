...
function HomePage() {
    ...
    const fetchMeetings = async () => {
        try {
            const response = await fetch('http://localhost:8888/api/v1/meetings', {
                headers: {
            ...
            console.log('Meetings data:', meetingsData); // Log the response data
        ...
        <>
            ...
            >
                ...
                <div className="flex flex-row justify-evenly ">
                    <div className="w-1/5 h-full flex flex-col rounded-xl mb-32"
                         style={bgMeetingCard}
                    >
